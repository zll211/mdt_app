...
class MDTTab extends StatelessWidget {
  ...
  Widget _buildLabelText() {
    return child ?? Text(text, softWrap: false, overflow: TextOverflow.fade, style: TextStyle(fontWeight: FontWeight.bold));
  }
...
class _IndicatorPainter extends CustomPainter {
  ...
  final MDTTabBarIndicatorSize indicatorSize;
  ...
  Rect indicatorRect(Size tabBarSize, int tabIndex) {
    ...
    if (indicatorSize == MDTTabBarIndicatorSize.label) {
...
class MDTTabBar extends StatefulWidget implements PreferredSizeWidget {
...
class _TabBarState extends State<MDTTabBar> {
  ...
  @override
  void didUpdateWidget(MDTTabBar oldWidget) {
